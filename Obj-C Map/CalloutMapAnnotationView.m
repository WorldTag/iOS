...
#define CalloutMapAnnotationViewContentHeightBufferSize 8.0f
...
@synthesize parentAnnotationView = parentAnnotationView;
@synthesize mapView = mapView;
@synthesize contentView = contentView;
@synthesize animateOnNextDrawRect = animateOnNextDrawRect;
@synthesize endFrame = endFrame;
@synthesize yShadowOffset = yShadowOffset;
@synthesize offsetFromParent = offsetFromParent;
...
- (void)prepareFrameSize {
    ...
    CalloutMapAnnotationViewContentHeightBufferSize +
